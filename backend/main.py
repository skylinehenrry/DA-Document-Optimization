"""Command-line entry point for the reviewed workflow.

Analysis stops at a saved draft. Generation is a separate, revision-specific
operation. Run python -m backend.main --help from the project directory.
"""
