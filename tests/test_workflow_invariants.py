"""Storage, review and enrichment invariants using snapshots and fake providers.

These fixtures deliberately bypass language extraction so failures identify a
workflow/integrity problem rather than a parser heuristic or a live model.
"""
